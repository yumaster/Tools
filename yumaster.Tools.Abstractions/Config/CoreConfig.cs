...
namespace yumaster.Tools.Core.Config
{
...
namespace yumaster.Tools.Core.Config
{
    ...
    public static class ConfigHelper
    {
        ...
        /// <summary>
        /// 将配置添加到yumaster.Tools，若未调用，将自动加载默认的appsettings.json
        /// </summary>
        /// <param name="config"></param>
        public static void AddToYumasterTools(this IConfiguration config)
        {
