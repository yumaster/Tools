using yumaster.Tools.Core.Config;
using yumaster.Tools.Models;
...
namespace yumaster.Tools.Core.Net
{
    /// <summary>
    /// Web操作扩展
    /// </summary>
    public static class WebExtension
    {
        ...
        public static async Task<PhysicsAddress> GetPhysicsAddressInfo(this string ip)
        {
            ...
            {
                throw new Exception("未配置BaiduAK，请先在您的应用程序appsettings.json中下添加BaiduAK配置节(注意大小写)；或手动在程序入口处调用IConfiguration的AddToYumasterTools方法");
            }
