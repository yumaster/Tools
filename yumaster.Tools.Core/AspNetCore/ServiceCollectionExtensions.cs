using yumaster.Tools.AspNetCore.ResumeFileResults.Executor;
using yumaster.Tools.AspNetCore.ResumeFileResults.ResumeFileResult;
using yumaster.Tools.Core.Net;
using yumaster.Tools.Files;
...
namespace yumaster.Tools.Core.AspNetCore
{
    /// <summary>
